          ...
          <div class="page-inner">
            <div
              ...
              <div>
                ...
                <h6 class="op-7 mb-2">You will try to create new product ...</h6>
              </div>
...
<button id="alert_demo_59" class="btn btn-primary">Add New Product</button>-->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="editProductForm">
          ...
          <div class="form-group">
            ...
            <input id="editProductName" type="text" class="form-control" required>
          </div>
          <div class="form-group">
            <label for="editProductPrice">Price</label>
            <input id="editProductPrice" type="number" class="form-control" required>
          </div>
         <div class="form-group">
                  <label for="editProductQuantity">Quantity</label>
                  <input id="editProductQuantity" type="number" class="form-control" placeholder="Enter product quantity" required>
         </div>

          <div class="form-group">
                  <label for="editProductTax">Tax</label>
                  <input id="editProductTax" type="number" class="form-control" placeholder="Enter product tax (without %) " required>
          </div>
       
        </form>
      </div>
      <div class="modal-footer border-0">
        <button type="button" id="updateProductButton" class="btn btn-primary">Update</button>
            ...
            <div class="modal-body">
              <form id="productForm">
                ...
                <div class="form-group">
                  ...
                  <input id="productPrice" type="number" class="form-control" placeholder="Enter product price" required>
                </div>

                    <div class="form-group">
                  <label for="productQuantity">Quantity</label>
                  <input id="productQuantity" type="number" class="form-control" placeholder="Enter product quantity" required>
                </div>

                          <div class="form-group">
                  <label for="productTax">Tax</label>
                  <input id="productTax" type="number" class="form-control" placeholder="Enter product tax (without %) " required>
                </div>
      ...
      <div class="table-responsive">
        <table id="product-table" class="display table table-striped table-hover">
          ...
          <tbody>
            <!-- Dynamic Product Rows Will Be Populated Here -->
          </tbody>
        </table>
      </div>
    </div>
...
<script>
// Fetch and display products from the server on page load
  ...
  $('#addProductButton').click(function() {
    ...
    const price = $('#productPrice').val();
      const qty = $('#productQuantity').val();
        const tax = $('#productTax').val();
    const category = $('#productCategory').val();

    if (name && price && category && tax & qty) {
      $.ajax({
        url: 'add_product.php',
        method: 'POST',
        data: { name, price, category, qty,tax},
        success: function() {
  ...
  $.ajax({
    ...
    success: function(product) {
      ...
      $('#editProductPrice').val(product.price);
       ...
       $('#editProductTax').val(product.tax);
...
$('#updateProductButton').click(function() {
  ...
  const tax = $('#editProductTax').val();
  const quantity = $('#editProductQuantity').val();

  if (name && price && tax && quantity) {
    $.ajax({
      url: 'update_product.php',
      method: 'POST',
      data: { id, name, price, tax, quantity },
      success: function() {
